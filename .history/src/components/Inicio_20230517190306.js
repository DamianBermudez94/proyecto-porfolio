    ...
    <div className='home'>
      ...
      <section className='section-me'>
            ...
            <div className='container-me' data-animation="diagonal" >
              ...
              </a> donde actualmente estoy cursando la carrera de programacion web full stack, además estoy realizando dos cursos en la plataforma udemy, uno <strong>Master en React</strong> y el otro Master en JavaScript.</p>
            </div>     
      </section>
