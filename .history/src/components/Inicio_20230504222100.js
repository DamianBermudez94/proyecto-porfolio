...
export const Inicio = () => {
  return (
    <div className='home'>
       <h1 class="title-welcome" style={{var:"--duration: 1s"}}>
                    <span style={{"--total":"delay: .5s"}}>Hola! Mi nombre es,</span>
                    <span class="title-custom" style={{"--total":"delay: .6s"}}>Damián Bermúdez.</span>
                </h1>
      <p class="parrafo-welcome" style ={{"--total":"--duration: 1s"}}><span style={{"--total":"--delay: .7s"}}>Developer web full stack.</span><span class="punto-color">.</span></p>
