    ...
    <div>
      ...
      <div class="container-skills">
        <ul>
          ...
          <li><img class="img-skills" src="./image/postman_macos_bigsur_icon_189815.png" alt="postman Damian Bermudez"/><p>Postman</p></li>
          <li><img class="img-skills" src="./image/vercel_brand_icon_211876.png" alt="vercel Damian Bermudez"/><p>Vercel</p></li>
