    ...
    <div className='home'>
      ...
      <section className='section-me'>
            ...
            <div>
              ...
              <span class="border border-left"></span></a> donde actualmente estoy cursando la carrera de programacion web full stack.</p>
            </div>     
      </section>
      <section className='lasts-works' data-animation="diagonal" >
