    ...
    <div className='home'>
      ...
      <section className='section-me' data-animation="diagonal" >
            ...
            <div className='container-me' data-animation="diagonal" >
              ...
              <p>Hola!! Soy Damián Bermúdez, tengo 28 años y soy de Lobos - Provincia de Buenos Aires - Argentina. Soy <strong>Developer web full stack</strong>. Empece a estudiar programación de aplicaciones moviles en 2020, en un instituto de mi localidad, por cuestiones de tiempo (muchas materias y además trabajo en un fabrica metalurgica 9 horas) tuve que dejar. Empece de forma autodidacta estudiando desarrollado web y quede encantado. Fui adquiriendo los conocimientos basicos hasta que me tope con un anuncio en las redes sociales de la plataforma <a class="enlace-carrera" data-animation="diagonal"  href="https://apx.school/" >APX
      ...
      <section className='lasts-works' >
            ...
            <p className='parrafo-contacto'>
              Te ayudo a crear tu sitio o aplicacion web para tener mas visibilidad y relevancia en internet. <NavLink to="/contacto">Contactate
