  ...
  return (
    <div className='home'>
      <section className='home-welcome'>
          ...
          <div>
            <NavLink to="https://www.instagram.com" className="link-redes_sociales" ><i className="fab fa-instagram instagran"></i></NavLink>
            ...
            <NavLink to="https:/www.github.com" className="link-redes_sociales" ><i className="fab fa-github-square github"></i></NavLink>
          </div>
      </section>
